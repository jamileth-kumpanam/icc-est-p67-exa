...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /// CODE
        List<Pedido> listaBase = crearPedidos();
        ...
        System.out.println();
        /// CODE
        Stack<Pedido> filtrados = controller.filtarPorZona(listaBase, 150);
        ...
        System.out.println();
        /// CODE
        TreeSet<Pedido> ordenados = controller.ordenarPorZona(filtrados);
        ...
        System.out.println();
        TreeMap<Integer, Queue<Pedido>> agrupados = controller.agruparPorUrgencia(listaBase);
        ...
        // Stack
        /// CODE
        System.out.println("\n=== MÉTODO D: Explotar Grupo ===");
        System.out.println();
        Stack<Pedido> explotado = controller.explotarGrupo(agrupados);
